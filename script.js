function initMap() {
  ...
  var locations_banc = [
    ...
    { lat: 48.67486797125592, lng: 6.175523840098286, title: "Le Banc d'Arrêt de Bus", description: "J'ai toujours critiqué ce banc, le trouvant mal placé et inutile. Jusqu'au jour où, attendant le bus, j'ai traversé la rue rien que pour m'y asseoir.", images: ["Photos pour les Markers/Bus.jpg"]}
  ];
